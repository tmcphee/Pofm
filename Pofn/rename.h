...
void renameLocal() {
	...
	char *newname, *n, *filepath;	//char pointers to store file name, directory name, and full path to file
	String name = createString();	//name of file
	String source = createString();	//name of source directory
	String rename = createString();	
	int found = 0;
	...
	//result = rename(entry->d_name, newname);
